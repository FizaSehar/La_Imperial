...
(function(h)
	{
		...
		g=u||v,m=g?v?f?"MSPointerDown":"pointerdown":"touchstart":"mousedown",
	...
	h.fn.extend(
		{
				...
				if(1==q)
					{
						...
						a=t+"s",
						n=0!==t?"all":"none";
						this.css({"-webkit-transition-property":n,
					...
					this.css(
						{
							...
							transform:"translateX("+t+a+")"})):this.css(
			{
				"margin-left":t}),
							this
						}
							...
							animateX:function(t,i)
							{
								...
								function(){
									...
									animateFade:function(t)
									{
										...
										this.hasClass("event-attached")||this.addClass("event-attached").on(a,
											function(t)
											{
											-1!=t.originalEvent.propertyName.indexOf("opacity")
											&&0!=h(this).css("z-index")
											&&h(this).getSlider().slideComplete()
											}
									...
									),h.fn.extend(
									{
										sliderInit:function(t){
											...
											n={
												...
												(isNaN(e.speed)
												||e.speed<0)
												&&(e.speed=a.speed),(isNaN(e.delay)
												||e.delay<0)
												&&(e.delay=a.delay),
												"slide"!=e.transition
												&&"fade"!=e.transition
												&&(e.transition=a.transition),
												"slide"!=e.transition
												&&(e.group=1),g
												&&("hover"==e.navigation
												&&(e.navigation="none"),
												...
												&&(s=Math.ceil(this.find(r).index()/e.group),
				...
				{
					if(e>=n.length)return clearInterval(I[a].showInterval),
				i;
				var t=n.eq(e);
				q?t.css({
				top:t.data("top"),
			...
			t.hasClass("appear-right")&&t.css("left",
			a+15),
			t.css("opacity",0)
	}),
	this
...
,
	...
	{h("body .jSlider").each(function(){h(this).sliderResized()})})});
